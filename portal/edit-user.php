                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="edit-user.php?email=$email">Edit User</a>
                            </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit User Biodata Form</h4>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="email" id="roundText" class="form-control round" placeholder="Enter The E-mail" name="email" 
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                                    <fieldset class="form-group">
                                                        <label for="roundText">Password (Optional)</label>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                                    <button type="submit" class="btn btn-secondary btn-lg btn-block" name="update-user">UPDATE THE USER</button>
                                                </div>
