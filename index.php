                        ...
                        <div class="col-md-4 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                   <div class="card-body">
                                        <form class="form-horizontal" action="process-login.php" novalidate method="POST">
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="email" name="email" class="form-control" id="user-name" placeholder="Your Username" required>
                                            ...
                                            <button type="submit" class="btn btn-outline-primary btn-block" name="login"><i class="ft-unlock"></i> Login</button>
                                        </form>
                                    </div>
